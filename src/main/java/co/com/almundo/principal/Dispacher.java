 ...
 */
package co.com.almundo.principal;
...
public class Dispacher extends Thread {
	...
	/**
	 * Gets el empleados disponibles.
	 *
	 * @return el empleados disponibles
	 */
	...
	/**
	 * Sets el empleados disponibles.
	 *
	 * @param empleadosDisponibles
	 *            el new empleados disponibles
	 */
